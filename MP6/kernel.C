...
void fun3() {
    ...
    // here is used for testing option 3 and option 4 design bonus
    // unsigned char buf[DISK_BLOCK_SIZE];
    // int  read_block  = 1;
    // int  write_block = 0;
    ...
    //    /* -- Read */
    //    Console::puts("Reading a block from disk fun 3...\n");
    //    SYSTEM_DISK->read(read_block, buf);
...
int main() {
    ...
    MIRROR = new MirroredDisk(DISK_ID::DEPENDENT, MIRROR_SIZE);
